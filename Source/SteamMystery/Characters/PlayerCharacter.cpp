...
#include "SteamMystery/Components/InteractionComponent.h"
...
APlayerCharacter::APlayerCharacter()
{
	...
	SpringArm->AttachToComponent(GetMesh(), FAttachmentTransformRules::KeepRelativeTransform, TEXT("Eyes_Position"));
